...
const ContactUs = () => {
  ...
  return (
    <div>
      <div className="">
        <section className="relative z-10 overflow-hidden bg-gray-200 py-20 lg:py-[120px]">
          <div className="container mx-auto">
            <div className="mx-4 flex flex-wrap lg:justify-between">
             
            <div className="w-full px-4 ml-5 lg:w-1/2 xl:w-5/12">
                  ...
                  <form method="post" onSubmit={handleSubmit}>
                      ...
                      <>
                        <div className="mb-6">
                          <input
                            type="text"
                            placeholder="الاسم"
                            className="text-body-color text-right border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none shadow-md transition duration-300"
                            value={name}
                    ...
                    <div className="mb-6">
                      <textarea
                        ...
                        className="text-body-color text-right border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none shadow-md transition duration-300"
                        value={message0}
              ...
              <div className="w-full  lg:w-1/3 xl:w-6/12">
                <div
                  className="mb-12 max-w-[570px] lg:mb-0"
                  style={{ marginRight: "60px", marginLeft: "65px" }}
                >
                  <h2 className="text-dark text-right mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                    تواصل معنا 
                  </h2>
                  <h4 className="text-body-color text-right mb-9 text-base leading-relaxed">
                      هل لديك اي استفسار او ان تترلك لنا رسالة عبر الايميل او رقم الهاتف
                  </h4>
                  <div className="mb-8 flex w-full justify-end">
                  <div className="">
                      <h4 className="text-dark text-right mb-1 text-xl font-bold">
                        موقعنا
                      </h4>
                      <p className="text-body-color text-right text-base">
                       الاردن الزرفاء 
                      </p>
                    </div>
