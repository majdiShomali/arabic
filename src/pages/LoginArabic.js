          ...
          <div className="w-full flex-1 mt-8">
            <div className="flex flex-col items-center ">
              <button
                ...
                onClick={() => login()}
              >
                      <span className="mr-4">تسجيل الدخول باستخدام جوجل</span>
            ...
            <div className="my-12 border-b text-center">
              <div className="leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2">
                او تسجيل الدخول بحساب الكتروني
              </div>
            </div>
            <form onSubmit={handleSubmit}>
              <div className="mx-auto max-w-xs">
                <input
                  className="w-full text-right px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                  type="email"
                ...
                <input
                  className="w-full text-right px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                  type="password"
