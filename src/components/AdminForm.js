...
//   const { MyListAdminU, updateMyListAdminU } = useContext(UserContext);
//   const { MyListNAdminU, updateMyListNAdminU } = useContext(UserContext);
...
//     tableTEst[ButtonStatusId].Name=name
//     tableTEst[ButtonStatusId].Category=yourSelectedStateValue
//     tableTEst[ButtonStatusId].Names=[name1,name2,name3]
//     tableTEst[ButtonStatusId].Links=[link_name001,link_name002,link_name003]
//     tableTEst[ButtonStatusId].Items=MyListAdminU
//     tableTEst[ButtonStatusId].ItemsName=MyListNAdminU
//     console.log(MyListNAdminU)
//     setTable(tableTEst)
...
//   setLink2(e.Links[1])
//   setLink3(e.Links[2])
//   updateMyListAdminU(e.Items)
//   updateMyListNAdminU(e.ItemsName)
