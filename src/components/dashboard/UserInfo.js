              ...
              return (
                <tbody role="rowgroup">
                  <tr role="row">
                    ...
                    >
                      <p className="text-sm font-bold text-navy-700 dark:text-white">
                        {e.role == 0 ?  <div className=" w-10 flex flex-col justify-center items-center" > <Icon path={mdiAccountOutline} size={1} />  <span>user</span> </div> : <div className=" w-10 flex flex-col justify-center items-center"> <Icon path={mdiShieldCrownOutline} size={1} />  <span>Admin</span> </div> }
...
<Icon path={mdiAccountOutline} size={1} /> */}
                    ...
                    <td
                      ...
                      role="cell"
                    >
                      <button onClick={() => handleUpdate(e._id,e.role,e.firstName)}>
                        
                        
                        {e.role == 0 ? <Icon color="blue" path={mdiHumanEdit} size={1} /> : <Icon color="blue" path={mdiHumanEdit} size={1} />}
                      </button>
                    </td>
